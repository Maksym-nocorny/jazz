  ...
  return (
    <section className="border-b border-border py-20 md:py-28">
      <Container className="grid gap-6 md:grid-cols-12">
        ...
        <div className="flex flex-col justify-between gap-8 rounded-lg bg-primary p-9 text-primary-foreground md:col-span-7 md:p-12">
          <div>
        ...
        <div id="hurt" className="flex flex-col justify-between gap-8 rounded-lg border border-border bg-surface-raised p-9 md:col-span-5 md:p-12">
          <div>
